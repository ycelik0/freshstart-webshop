  ...
  return (
    <nav className='navbar'>
      <div className="navbar__brand">
        <Link to='/' onClick={()=>{setMenuActive('unactive')}}>Kicks</Link>
      </div>
      ...
      <button className={`navbar__icon hamburger-menu ${menuActive}`}
        style={{ display: windowSize >= 800 ? 'none' : 'block' }} onClick={menuHandler}>
        <span></span>
        <span></span>
        <span></span>
      </button>
      <button className='navbar__icon shoppingcart-icon'
